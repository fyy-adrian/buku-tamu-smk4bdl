<footer class="bg-white">
    <div class="container mx-auto px-8">
      <div class="w-full flex flex-col md:flex-row py-6">
        <div class="flex-1 mb-6 text-black mr-14">
          <a class="no-underline hover:no-underline font-bold text-purple-600 text-2xl lg:text-4xl" href="#">
        ...
        <div class="flex-1">
          <p class="uppercase text-gray-500 md:mb-6">Author</p>
          <ul class="list-reset mb-6">
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-purple-600">Rafi Adrian</a>
            </li>
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-purple-600">M. Riandra</a>
            </li>
          </ul>
        </div>
        <div class="flex-1">
        ...
        <div class="flex-1">
          ...
          <ul class="list-reset mb-6">
            ...
            <li class="mt-2 inline-block mr-2 md:block md:mr-0">
              <a href="#" class="no-underline hover:underline text-gray-800 hover:text-purple-600">Contact</a>
            </li>
          </ul>
        </div>
      </div>
